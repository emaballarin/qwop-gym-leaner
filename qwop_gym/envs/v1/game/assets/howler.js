...
(function () {
        ...
        _enableiOSAudio: function () {
            ...
            if (!g || (!a._iOSEnabled && /iPhone|iPad|iPod/i.test(navigator.userAgent))) {
                ...
                var b = function () {
                    ...
                    setTimeout(function () {
                        if (d.playbackState === d.PLAYING_STATE || d.playbackState === d.FINISHED_STATE)
                            ((a._iOSEnabled = !0),
                                (a.iOSAutoEnable = !1),
    ...
    r.prototype = {
            ...
            if (!q) {
                for (var c = 0; c < a._urls.length; c++) {
                    ...
                    if (a._format) d = a._format;
                        ...
                        ((e = a._urls[c]),
                        (d = /^data:audio\/([^;,]+);/i.exec(e)) || (d = /\.([^.]+)$/.exec(e.split("?", 1)[0])),
                        d)
                    )
                        d = d[1].toLowerCase();
                    else {
        ...
        urls: function (a) {
            return a
                ? (this.stop(), (this._urls = "string" === typeof a ? [a] : a), (this._loaded = !1), this.load(), this)
                : this._urls;
        },
        play: function (a, b) {
            var c = this;
            ...
            c._inactiveNode(function (d) {
                ...
                var e = 0 < d._pos ? d._pos : c._sprite[a][0] / 1e3,
                    f = 0;
                c._webAudio
                    ? ((f = c._sprite[a][1] / 1e3 - d._pos), 0 < d._pos && (e = c._sprite[a][0] / 1e3 + e))
                ...
                (function () {
                    l = setTimeout(function () {
                        ...
                        c._webAudio &&
                            !h &&
                            ((c._nodeById(m).paused = !0), (c._nodeById(m)._pos = 0), c._clearEndTimer(m));
        ...
        _drainPool: function () {
            ...
            for (b = this._audioNode.length - 1; 0 <= b && !(5 >= a); b--)
                this._audioNode[b].paused &&
                    (this._webAudio && this._audioNode[b].disconnect(0), a--, this._audioNode.splice(b, 1));
        },
        _clearEndTimer: function (a) {
            ...
            if ((a = this._onendTimer[b])) (clearTimeout(a.timer), this._onendTimer.splice(b, 1));
        },
    ...
    if (l)
        var x = function (a, b) {
            ...
            y = function (a, b, c) {
                ...
                b[0] && ((c.bufferSource.loopStart = b[1]), (c.bufferSource.loopEnd = b[1] + b[2]));
